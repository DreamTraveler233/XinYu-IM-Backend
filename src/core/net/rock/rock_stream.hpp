#ifndef __IM_NET_ROCK_ROCK_STREAM_HPP__
#define __IM_NET_ROCK_ROCK_STREAM_HPP__

#include "core/net/streams/async_socket_stream.hpp"
#include "rock_protocol.hpp"
#include "core/net/streams/load_balance.hpp"
...
namespace IM
{
    ...
    public:
        ...
        typedef std::function<bool(RockRequest::ptr, RockResponse::ptr, RockStream::ptr)> request_handler;
        typedef std::function<bool(RockNotify::ptr, RockStream::ptr)> notify_handler;
...
#endif // __IM_NET_ROCK_ROCK_STREAM_HPP__
