#ifndef __IM_NET_STREAMS_SOCKET_STREAM_HPP__
#define __IM_NET_STREAMS_SOCKET_STREAM_HPP__

#include "core/io/iomanager.hpp"
#include "core/net/core/socket.hpp"
...
#endif // __IM_NET_STREAMS_SOCKET_STREAM_HPP__