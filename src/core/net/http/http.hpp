#ifndef __IM_NET_HTTP_HTTP_HPP__
#define __IM_NET_HTTP_HTTP_HPP__
...
#undef XX
     ...
     public:
           ...
           * @brief 构造函数
           * @param[in] version 版本
           * @param[in] close 是否自动关闭（HTTP/1.1 默认 keep-alive）
           */
...
#endif // __IM_NET_HTTP_HTTP_HPP__