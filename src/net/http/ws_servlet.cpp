...
int32_t FunctionWSServlet::onConnect(IM::http::HttpRequest::ptr header,
                                     IM::http::WSSession::ptr session) {
    if (m_onConnect) {
...
int32_t FunctionWSServlet::onClose(IM::http::HttpRequest::ptr header,
                                   IM::http::WSSession::ptr session) {
    if (m_onClose) {
...
int32_t FunctionWSServlet::handle(IM::http::HttpRequest::ptr header,
